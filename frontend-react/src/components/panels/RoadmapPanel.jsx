...
const ROADMAP = [
  ...
  { phase: 'Phase 5 — Autonomous Intelligence', items: [
    ...
    { v:'V25', name:'JARVIS OS Ultimate', desc:'Unified controller, PWA, smart home, themes, commands, launcher, voice, sync, mobile, hotkeys, widgets, tray, boot', pct:100, features:'Unified Controller ✅ | System Overview ✅ | Mode Switching ✅ | System Search ✅ | Quick Actions ✅ | PWA Manifest ✅ | Mobile Config ✅ | Smart Home Hub ✅ | Device Manager ✅ | Scenes ✅ | Rooms ✅ | Notification Center ✅ | Unread Tracking ✅ | Service Worker Stub ✅ | Offline Cache Config ✅ | Command Palette ✅ | Command Search ✅ | Custom Commands ✅ | Theme Engine ✅ | 4 Built-In Themes ✅ | Custom Themes ✅ | Theme Export ✅ | App Launcher ✅ | Pinned Apps ✅ | Favorites ✅ | Voice Hub ✅ | Wake Word Config ✅ | Voice Selection ✅ | Live Sync Engine ✅ | Device Pairing ✅ | Sync Queue ✅ | Conflict Resolution ✅ | Mobile App Shell ✅ | Bottom Nav ✅ | Gestures ✅ | Haptics ✅ | Global Hotkeys ✅ | Hotkey Profiles ✅ | Widget Framework ✅ | 10 Built-In Widgets ✅ | Custom Widgets ✅ | Widget Layouts ✅ | System Tray ✅ | Tray Badge ✅ | Boot Manager ✅ | Boot Sequence ✅ | Auto-Start ✅' },
  ]},
];
