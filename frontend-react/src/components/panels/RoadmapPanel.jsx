...
const ROADMAP = [
  ...
  { phase: 'Phase 2 — Specialized Agents', items: [
    ...
    { v:'V13', name:'Mnemosyne (Memory Agent)', desc:'Episodic, semantic, preferences', pct:55, features:'User Preferences ✅ | Knowledge Base ⚠️ | Semantic Search ✅ | User Profile ✅ | Short-Term Context ✅ | Episodic ❌ | Compression ❌' },
  ...
  { phase: 'Phase 4 — AI Operating System', items: [
    { v:'V21', name:'Plugin Marketplace', desc:'Plugin store, third-party integrations', pct:18, features:'Plugin Loader ✅ | Hot Reload ✅ | Plugin Discovery ✅ | Plugin Store UI ❌ | Remote Install ❌ | Sandboxing ❌' },
    { v:'V22', name:'Hybrid AI', desc:'Local + cloud models, auto routing', pct:78, features:'Ollama Local ✅ | Groq Cloud ✅ | OpenAI GPT-4o ✅ | Anthropic Claude ✅ | Google Gemini ✅ | Provider Switching ✅ | Multi-Model Reasoning ✅ | Smart Auto-Routing ✅ | Cost Optimization ⚠️' },
  ...
  { phase: 'Phase 5 — Autonomous Intelligence', items: [
    { v:'V24', name:'Self-Improving JARVIS', desc:'Auto-fix, performance, optimization', pct:28, features:'Error Auto-Fix (LLM) ✅ | Error Tracker ✅ | Health Monitor ✅ | Alert System ✅ | Self-Heal Middleware ✅ | Performance Tuning ⚠️ | Prompt Improve ❌ | Memory Optimize ❌' },
