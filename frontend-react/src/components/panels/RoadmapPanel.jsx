...
const ROADMAP = [
  ...
  { phase: 'Phase 2 — Specialized Agents', items: [
    ...
    { v:'V10', name:'Apollo (Creative)', desc:'Image gen, writing, video pipeline, UI, logos, presentations, design tokens', pct:92, features:'Image Gen (Pollinations) ✅ | 14 Art Styles ✅ | Creative Writing ✅ | Video Gen ✅ | UI Mockups ✅ | Logo Design ✅ | Presentations ✅ | Creative Log ✅ | Full Video Pipeline ✅ | Scene Generator ✅ | Presentation Gen V2 ✅ | Theme Presets ✅ | Design Tokens ✅ | Creative Stats ✅ | Full Render ⚠️' },
  ...
  { phase: 'Phase 3 — Intelligence Layer', items: [
    ...
    { v:'V20', name:'Multi-Agent Collaboration', desc:'Pipelines, parallel, coordination, load balancing, health', pct:95, features:'Shared Context ✅ | Sequential Chaining ✅ | Message Bus ✅ | Pipeline Orchestrator ✅ | Parallel Execution ✅ | Peer-to-Peer Mail ✅ | Agent Groups ✅ | Dependency Resolution ✅ | Real-Time Status ✅ | Resource Locks ✅ | Conflict Resolution ✅ | Coordination Protocol ✅ | Load Balancing ✅ | Health Checks ✅ | Auto-Redistribute ✅ | Live Orchestration ⚠️' },
  ]},
  { phase: 'Phase 4 — AI Operating System', items: [
    { v:'V21', name:'Plugin Marketplace', desc:'Store, install, ratings, sandbox, versioning, dependencies', pct:85, features:'Plugin Loader ✅ | Hot Reload ✅ | Plugin Discovery ✅ | Store Catalog ✅ | Browse & Search ✅ | Install/Uninstall ✅ | Ratings & Reviews ✅ | Sandbox Check ✅ | Categories ✅ | Store Stats ✅ | Versioning ✅ | Update Check ✅ | Plugin Update ✅ | Dependency Resolution ✅ | Featured Plugins ✅ | Changelog ✅ | Remote Registry ⚠️ | Auto-Update ⚠️' },
    ...
    { v:'V23', name:'AI Operating System', desc:'Multi-user, permissions, API gateway, sessions, bg tasks', pct:55, features:'Health Monitor ✅ | User Management ✅ | Role-Based Permissions ✅ | Session Management ✅ | API Gateway ✅ | API Key Management ✅ | Rate Limiting ✅ | Background Task Runner ✅ | Permission Engine ✅ | OS Status ✅ | Cross Device ⚠️ | Cloud Sync ❌' },
  ]},
  { phase: 'Phase 5 — Autonomous Intelligence', items: [
    { v:'V24', name:'Self-Improving JARVIS', desc:'Auto-fix, performance, prompt tuning, quality scoring, learning loops', pct:92, features:'Error Auto-Fix (LLM) ✅ | Error Tracker ✅ | Health Monitor ✅ | Alert System ✅ | Self-Heal Middleware ✅ | Performance Tracker ✅ | Slow Query Detection ✅ | Prompt Auto-Improve ✅ | Memory Optimizer ✅ | Data Compaction ✅ | Auto-Tuner ✅ | Optimization Suggestions ✅ | Quality Scorer ✅ | Auto-Retry Engine ✅ | Learning Feedback Loop ✅ | Weak Area Detection ✅ | Quality Trends ✅ | ML-Based Tuning ⚠️' },
