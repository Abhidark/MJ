...
const ROADMAP = [
  ...
  { phase: 'Phase 2 — Specialized Agents', items: [
    ...
    { v:'V10', name:'Apollo (Creative)', desc:'Image gen, writing, video, UI, logos, presentations', pct:72, features:'Image Gen (Pollinations) ✅ | 14 Art Styles ✅ | Creative Writing ✅ | Video Gen ✅ | UI Mockups ✅ | Logo Design ✅ | Presentations ✅ | Creative Log ✅ | Full Video ⚠️' },
    ...
    { v:'V13', name:'Mnemosyne (Memory Agent)', desc:'Episodic, semantic, preferences, decay, indexing', pct:92, features:'User Preferences ✅ | Knowledge Base ✅ | Semantic Search ✅ | User Profile ✅ | Short-Term Context ✅ | Episodic Memory ✅ | Memory Compression ✅ | Timeline ✅ | Importance Scoring ✅ | Memory Decay ✅ | Knowledge Indexer ✅ | Auto-Categorize ✅ | Consolidation ⚠️' },
    { v:'V14', name:'Chronos (Time Agent)', desc:'Reminders, calendar, planning, recurring, timezone', pct:90, features:'Reminders ✅ | Productivity Tracking ✅ | Calendar Events ✅ | Daily Planning ✅ | Time Blocks ✅ | Streaks ✅ | Recurring Events ✅ | Timezone Convert ✅ | Google Calendar Stub ✅ | Google Calendar Live ⚠️' },
  ...
  { phase: 'Phase 3 — Intelligence Layer', items: [
    ...
    { v:'V19', name:'Workflow Engine', desc:'Automation, parallel execution, event triggers', pct:88, features:'Workflow CRUD ✅ | Daily Briefing ✅ | Task Planning ✅ | Sequential Execution ✅ | Morning Routine ✅ | News Digest ✅ | Email Auto-Sort ✅ | Scheduled Triggers ✅ | Templates ✅ | Event Triggers ✅ | Parallel Workflows ✅ | Condition Triggers ✅ | Trigger Stats ✅ | Live Orchestration ⚠️' },
    { v:'V20', name:'Multi-Agent Collaboration', desc:'Pipelines, parallel, coordination, conflict resolution', pct:82, features:'Shared Context ✅ | Sequential Chaining ✅ | Message Bus ✅ | Pipeline Orchestrator ✅ | Parallel Execution ✅ | Peer-to-Peer Mail ✅ | Agent Groups ✅ | Dependency Resolution ✅ | Real-Time Status ✅ | Resource Locks ✅ | Conflict Resolution ✅ | Coordination Protocol ✅ | Live Orchestration ⚠️' },
  ]},
  { phase: 'Phase 4 — AI Operating System', items: [
    { v:'V21', name:'Plugin Marketplace', desc:'Store catalog, install, ratings, sandboxing', pct:65, features:'Plugin Loader ✅ | Hot Reload ✅ | Plugin Discovery ✅ | Store Catalog ✅ | Browse & Search ✅ | Install/Uninstall ✅ | Ratings & Reviews ✅ | Sandbox Check ✅ | Categories ✅ | Store Stats ✅ | Remote Registry ⚠️ | Auto-Update ❌' },
    ...
    { v:'V23', name:'AI Operating System', desc:'Multi-user, permissions, sync', pct:8, features:'Health Monitor ✅ | Background Services ⚠️ | Multi User ❌ | Permissions ❌ | API Gateway ❌ | Cross Device ❌' },
  ]},
  { phase: 'Phase 5 — Autonomous Intelligence', items: [
    { v:'V24', name:'Self-Improving JARVIS', desc:'Auto-fix, performance, prompt tuning, memory optimization', pct:75, features:'Error Auto-Fix (LLM) ✅ | Error Tracker ✅ | Health Monitor ✅ | Alert System ✅ | Self-Heal Middleware ✅ | Performance Tracker ✅ | Slow Query Detection ✅ | Prompt Auto-Improve ✅ | Memory Optimizer ✅ | Data Compaction ✅ | Auto-Tuner ✅ | Optimization Suggestions ✅ | ML-Based Tuning ⚠️' },
    { v:'V25', name:'JARVIS OS Ultimate', desc:'Everything unified as one AI OS', pct:0, features:'Full Integration ❌ | Mobile App ❌ | PWA ❌ | Smart Home ❌ | Cross-Device Sync ❌' },
  ]},
];
