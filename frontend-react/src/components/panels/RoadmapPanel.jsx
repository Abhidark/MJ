...
const ROADMAP = [
  ...
  { phase: 'Phase 4 — AI Operating System', items: [
    { v:'V21', name:'Plugin Marketplace', desc:'Store, install, ratings, sandbox, versioning, registry, auto-update', pct:95, features:'Plugin Loader ✅ | Hot Reload ✅ | Plugin Discovery ✅ | Store Catalog ✅ | Browse & Search ✅ | Install/Uninstall ✅ | Ratings & Reviews ✅ | Sandbox Check ✅ | Categories ✅ | Store Stats ✅ | Versioning ✅ | Update Check ✅ | Plugin Update ✅ | Dependency Resolution ✅ | Featured Plugins ✅ | Changelog ✅ | Remote Registry ✅ | Auto-Update ✅ | Plugin Health Monitor ✅ | Publish ✅ | Live Registry ⚠️' },
  ...
  { phase: 'Phase 5 — Autonomous Intelligence', items: [
    ...
    { v:'V25', name:'JARVIS OS Ultimate', desc:'Unified controller, PWA, smart home hub, notifications', pct:35, features:'Unified Controller ✅ | System Overview ✅ | Mode Switching ✅ | System Search ✅ | Quick Actions ✅ | PWA Manifest Stub ✅ | Mobile Config ✅ | Smart Home Hub ✅ | Device Manager ✅ | Scenes ✅ | Rooms ✅ | Notification Center ✅ | Unread Tracking ✅ | Full PWA ⚠️ | Mobile App ⚠️ | Cross-Device Live ❌' },
  ]},
];
